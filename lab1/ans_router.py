...
class Router(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        print("Packet-In received on datapath ID:", datapath.id)
        if is_not_router:
            return
    ...
    def handle_arp_request(self, arp_pkt, in_port, ev, pkt):
        ...
        # if its a request for the Router-IP, generate an ARP Reply
        ...
        if is_arp_request and is_arp_intended_for_router:
            ...
            #Chris TODO NOTE: I copied this code snippet again but dont understand it fully.
            arp_reply = arp.arp(
                hwtype=1,                      
                proto=0x0800,                  
                hlen=6,                        
