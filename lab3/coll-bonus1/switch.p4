        ...
        if (hdr.switchml.isValid()) {
            ...
            if (current_count == 0 || hdr.switchml.chunk_id > exp_chunk) {
                ...
                if ((current_bitmap & rank_mask) == 0) {
                    ...
                    pool0.read(p0, slot);
                    int<32> new_p0 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p0 = (hdr.switchml.val0 < SIGNED(32, p0)) ? hdr.switchml.val0 : p0;
                    } else if (hdr.switchml.op == 2) {
                        new_p0 = (hdr.switchml.val0 > SIGNED(32, p0)) ? hdr.switchml.val0 : p0;
                    } else {
                        new_p0 = p0 + hdr.switchml.val0;
                    }
                    ...
                    int<32> new_p1 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p1 = (hdr.switchml.val1 < SIGNED(32, p1)) ? hdr.switchml.val1 : p1;
                    } else if (hdr.switchml.op == 2) {
                        new_p1 = (hdr.switchml.val1 > SIGNED(32, p1)) ? hdr.switchml.val1 : p1;
                    } else {
                        new_p1 = p1 + hdr.switchml.val1;
                    }
                    ...
                    int<32> new_p2 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p2 = (hdr.switchml.val2 < SIGNED(32, p2)) ? hdr.switchml.val2 : p2;
                    } else if (hdr.switchml.op == 2) {
                        new_p2 = (hdr.switchml.val2 > SIGNED(32, p2)) ? hdr.switchml.val2 : p2;
                    } else {
                        new_p2 = p2 + hdr.switchml.val2;
                    }
                    ...
                    int<32> new_p3 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p3 = (hdr.switchml.val3 < SIGNED(32, p3)) ? hdr.switchml.val3 : p3;
                    } else if (hdr.switchml.op == 2) {
                        new_p3 = (hdr.switchml.val3 > SIGNED(32, p3)) ? hdr.switchml.val3 : p3;
                    } else {
                        new_p3 = p3 + hdr.switchml.val3;
                    }
                    ...
                    int<32> new_p4 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p4 = (hdr.switchml.val4 < SIGNED(32, p4)) ? hdr.switchml.val4 : p4;
                    } else if (hdr.switchml.op == 2) {
                        new_p4 = (hdr.switchml.val4 > SIGNED(32, p4)) ? hdr.switchml.val4 : p4;
                    } else {
                        new_p4 = p4 + hdr.switchml.val4;
                    }
                    ...
                    int<32> new_p5 = 0;
                    if (hdr.switchml.op == 1) {
                        new_p5 = (hdr.switchml.val5 < SIGNED(32, p5)) ? hdr.switchml.val5 : p5;
                    } else if (hdr.switchml.op == 2) {
                        new_p5 = (hdr.switchml.val5 > SIGNED(32, p5)) ? hdr.switchml.val5 : p5;
                    } else {
                        new_p5 = p5 + hdr.switchml.val5;
                    }
                    ...
                    if (current_count == (bit<16>)hdr.switchml.num_workers) {
                        ...
                        // Resend the completed result from the pools via BROADCAST.
                        int<32> p0 = 0;
                        pool0.read(p0, slot);
